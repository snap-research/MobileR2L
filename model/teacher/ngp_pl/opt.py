...
def get_opts():
    ...
    parser.add_argument('--dataset_name', type=str, default='nerf',
                        choices=['nerf', 'nsvf', 'colmap', 'custom', 'nerfpp', 'rtmv', 'pseudo', 'debug', 'LLFF'],
                        help='which dataset to train/test')
    parser.add_argument('--dataset_type', type=str, default='nerf',
                        choices=['nerf', 'colmap_360'],
                        help='which dataset to train/test')
    ...
    parser.add_argument('--save_pseudo_data', action='store_true', default=False,
                        help='whether to generate pseudo data')
    parser.add_argument('--n_pseudo_data', type=int, default=10000,
                        help='number of pseudo data to generate')
    
    parser.add_argument('--sr_downscale', type=int, default=8,
                        help='downsample scale for input height and width')
    parser.add_argument('--save_pseudo_path', type=str, default='./',
                    help='path to save the pseudo data')

    parser.add_argument('--ff', action='store_true', default=False,
                        help='whether it is forward-facing scenes')
